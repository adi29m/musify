...
export function PlaylistClient({ tracks }: { tracks: UiTrack[] }) {
  const { playTracks } = usePlayer();
  if (tracks.length === 0) return <p className="text-sm text-zinc-500">This playlist has no playable tracks right now.</p>;
  return (
    <div>
